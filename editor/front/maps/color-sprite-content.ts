...
export const ColorSpriteContent = new Map<ColorSpriteName, string>([
  ...
  [
    ...
    '<svg xmlns="http://www.w3.org/2000/svg" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:1.5" viewBox="0 0 60 60"><circle cx="30" cy="30" r="10" style="fill:#ff0;stroke:#000;stroke-width:4px"/></svg>',
  ],
  [
