  ...
  export(tower: Tower): ExportResult {
    ...
    enemies.sort((e1, e2) => {
      if (e1[IoEnemy.ATTRIBUTE_TYPE] !== e2[IoEnemy.ATTRIBUTE_TYPE]) {
        ...
        return (
          (e1[IoEnemy.ATTRIBUTE_LEVEL] as number) -
          (e2[IoEnemy.ATTRIBUTE_LEVEL] as number)
        )
        ...
        return (
          (e1[IoEnemy.ATTRIBUTE_HP] as number) -
          (e2[IoEnemy.ATTRIBUTE_HP] as number)
        )
      } else if (e1[IoEnemy.ATTRIBUTE_ATK] !== e2[IoEnemy.ATTRIBUTE_ATK]) {
        return (
          (e1[IoEnemy.ATTRIBUTE_ATK] as number) -
          (e2[IoEnemy.ATTRIBUTE_ATK] as number)
        )
      } else if (e1[IoEnemy.ATTRIBUTE_DEF] !== e2[IoEnemy.ATTRIBUTE_DEF]) {
        return (
          (e1[IoEnemy.ATTRIBUTE_DEF] as number) -
          (e2[IoEnemy.ATTRIBUTE_DEF] as number)
        )
      } else if (e1[IoEnemy.ATTRIBUTE_EXP] !== e2[IoEnemy.ATTRIBUTE_EXP]) {
        return (
          (e1[IoEnemy.ATTRIBUTE_EXP] as number) -
          (e2[IoEnemy.ATTRIBUTE_EXP] as number)
        )
